...
public abstract class Food {
    ...
    public String toString() {
        String str = String.format("%s:/n", name);
        str += String.format("Calories: %d, Grams: %d/n", calories, grams);
        str += String.format("Price: %.2f/n", price);
        return str;
    }
}
